...
public class Activity12_1 {
    public static void main(String[] args) {
        ...
        WebElement frameHeading1 = driver.findElement(By.xpath("//div[contains(@class,'activity')]//div[@class='content']"));
        System.out.println("First frame heading:\n"+frameHeading1.getText());
